...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__verifysignature__ = __webpack_require__(482);
...
var VerifysignaturePageModule = /** @class */ (function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_html2canvas__ = __webpack_require__(483);
...
var VerifysignaturePage = /** @class */ (function () {
    ...
    VerifysignaturePage.prototype.logForm = function () {
        ...
        this.restProvider.getSignature(this.data.order_ID).subscribe(function (res) {
            ...
            _this.imgInvoice = atob(_this.result.list_order);
            console.log(_this.imgInvoice);
        }, function (err) {
            console.log("Come there");
            console.log(err);
        });
    };
    VerifysignaturePage.prototype.printImg = function () {
        var _this = this;
        var element = document.getElementById('imgBill');
        __WEBPACK_IMPORTED_MODULE_3_html2canvas___default()(element).then(function (canvas) {
            var imgData = canvas.toDataURL("image/png");
            _this.imageInvoice = imgData;
            alert("Printed");
        });
    };
    VerifysignaturePage = __decorate([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-verifysignature',template:/*ion-inline-start:"E:\GHN\Projects\ionic-signature-pad\src\pages\verifysignature\verifysignature.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Verifysignature</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <div id="pad-container" #pad>\n    <form (ngSubmit)="logForm()">\n      <ion-item>\n        <ion-label>OrderID</ion-label>\n        <ion-input type="text" [(ngModel)]="data.order_ID" name="title"></ion-input>\n      </ion-item>\n      <button ion-button type="submit" block data-target="#addParticipantModal">Check signature</button>\n      <button ion-button color="danger" (click)="cancel()">Cancel</button>\n    </form>\n  </div>\n  <div class="container" id="imgBill">\n    <div class="row">\n      <div class="span4">\n        <img [src]="imgInvoice" class="img-rounded logo">\n        <address>\n            <strong>Hồ Chí Minh</strong><br>           \n        </address>\n      </div>\n      <div class="span4 well">\n        <table class="invoice-head">\n          <tbody>\n            <tr>\n              <td class="pull-right"><strong>Customer #</strong></td>\n              <td>{{result.reciever}}</td>\n            </tr>\n            <tr>\n              <td class="pull-right"><strong>Invoice #</strong></td>\n              <td>{{result.order_id}}</td>\n            </tr>\n            <tr>\n              <td class="pull-right"><strong>Date</strong></td>\n              <td>10-05-2019</td>\n            </tr>            \n          </tbody>\n        </table>\n      </div>\n    </div>\n    <div class="row">\n      <div class="span8">\n        <h2>Invoice</h2>\n      </div>\n    </div>\n    <div class="row">\n      <div class="span8 well invoice-body">\n        <table class="table table-bordered">\n        <thead>\n          <tr>\n            <th>Description</th>\n            <th>Date</th>\n            <th>Amount</th>\n            <th>Signature</th>\n          </tr>\n        </thead>\n        <tbody>\n        <tr>\n          <td>{{result.description}}</td>\n          <td>10/5/2019</td>\n          <td>$1000.00</td>\n          <td><img [src]="imgSignature"></td>\n        </tr>\n        </tbody>\n      </table>\n      </div>\n    </div>\n    <div class="row">\n      <div class="span8 well invoice-thank">\n        <h5 style="text-align:center;">Thank You!</h5>\n      </div>\n    </div>    \n  </div>\n  <button (click)="printImg()">Print Invoice</button> \n  <span>\n    <a href="{{imageInvoice}}" download="pqd.jpg" id="dwnldLink">DownLoad</a>\n  </span>\n</ion-content>\n'/*ion-inline-end:"E:\GHN\Projects\ionic-signature-pad\src\pages\verifysignature\verifysignature.html"*/,
            styles: ['verifysignature.scss']
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ViewController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ViewController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__providers_rest_rest__["a" /* RestProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_rest_rest__["a" /* RestProvider */]) === "function" && _d || Object])
    ], VerifysignaturePage);
